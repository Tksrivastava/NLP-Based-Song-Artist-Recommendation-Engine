...
# Importing Data -
data = pd.read_excel('https://github.com/Tksrivastava/NLP-Based-Song-Artist-Recommendation-Engine/blob/main/Reco/Final_Recommendation_Data.xlsx', index_col=0)
